...
const Countries = () => {
  return (
    ...
    <div className='country '>
      ...
      <div className='flex space-x-14 pt-4'>
    <div className='country  '>
      <img src="https://flagcdn.com/sn.svg" alt="" className='w-80 h-40 mt-0' />
    ...
    <div className='country '>
      <img src="https://upload.wikimedia.org/wikipedia/commons/5/5c/Flag_of_the_Taliban.svg" alt="" className='w-80 h-30 mt-4' />
    ...
    <div className='country '>
      ...
      <div className='flex space-x-14 pt-4'>
    <div className='country  '>
      <img src="https://flagcdn.com/lv.svg" alt="" className='w-80 h-40 mt-0' />
    ...
    <div className='country '>
      <img src="https://flagcdn.com/vn.svg" alt="" className='w-80 h-50 mt-0' />
      <h1 className='text-2xl font-bold pb-30 pt-0 '>Vietnam</h1>
      <p > <span className="text-green-900 font-bold">Capital:</span>Hanoi</p>
      <p> <span className="text-green-900 font-bold"> Population:</span>97338583</p>
      <p> <span className="text-green-900 font-bold">Region:</span>Asia</p>
    ...
    <div className='country '>
      ...
      <div className='flex space-x-14 pt-4'>
    <div className='country  '>
      <img src="https://flagcdn.com/pl.svg" alt="" className='w-80 h-40 mt-0' />
    ...
    <div className='country '>
      <img src="https://flagcdn.com/gu.svg" alt="" className='w-80 h-50 mt-0 ' />
    ...
    <div className='country '>
      <img src="https://flagcdn.com/lt.svg" alt="" className='w-80 h-30 mt-4' />
    ...
    <div className='country '>
      ...
      <div className='flex space-x-14 pt-4'>
    <div className='country  '>
      <img src="https://flagcdn.com/je.svg" alt="" className='w-80 h-40 mt-0' />
    ...
    <div className='country '>
      <img src="https://flagcdn.com/gd.svg" alt="" className='w-80 h-50 mt-0 ' />
    ...
    <div className='country '>
      <img src="https://flagcdn.com/et.svg" alt="" className='w-80 h-30 mt-0' />
    ...
    <div className='country '>
      ...
      <div className='flex space-x-14 pt-4'>
    <div className='country  '>
      <img src="https://flagcdn.com/ma.svg" alt="" className='w-80 h-40 mt-0' />
    ...
    <div className='country '>
      <img src="https://flagcdn.com/pr.svg" alt="" className='w-80 h-50 mt-0 ' />
    ...
    <div className='country '>
      <img src="https://flagcdn.com/nz.svg" alt="" className='w-80 h-30 mt-0' />
    ...
    <div className='country  '>
      <img src="https://flagcdn.com/gf.svg" alt="" className='w-80 h-40 mt-0' />
    ...
    <div className='country '>
      <img src="https://flagcdn.com/nu.svg" alt="" className='w-80 h-50 mt-4 ' />
    ...
    <div className='country '>
      <img src="https://flagcdn.com/sj.svg" alt="" className='w-80 h-30 mt-0' />
